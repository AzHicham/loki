...
fn test_no_filter(
    ...
    let responses = build_and_solve(&real_time_model, &fixture_model, &loki::LoadsData::empty(), &config)?;
    ...
    assert_eq!(journey.first_vj_uri(&real_time_model, &fixture_model), "toto");
